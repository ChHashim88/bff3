...
export default function Hero({ onOpenWaitlist }: HeroProps) {
  return (
    <section className="relative w-full min-h-[calc(100vh-64px)] sm:min-h-[calc(100vh-80px)] pt-16 sm:pt-20 lg:pt-28 pb-16 sm:pb-20 lg:pb-28 flex flex-col justify-start md:justify-center overflow-hidden border-b border-gray-200/70">
