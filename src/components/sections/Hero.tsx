  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-64px)] sm:min-h-[calc(100vh-80px)] py-16 sm:py-20 lg:py-28 flex flex-col justify-center overflow-hidden border-b border-gray-200/70">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-white via-white/80 to-white/20 md:hidden" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold text-gray-900 tracking-tight leading-[1.12] sm:leading-[1.08]"
          >
            Everyday investors.
            <br />
            Real ownership.
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center justify-center gap-2.5 bg-black hover:bg-neutral-800 text-white text-base font-semibold px-7 sm:px-8 py-4 sm:py-4 rounded-full sm:rounded-sm transition-all duration-200 shadow-xl hover:shadow-2xl cursor-pointer group"
            >
            ...
            <motion.a
              href="#why-bff"
              whileHover={{ x: 3 }}
              className="inline-flex items-center justify-center gap-1.5 text-base font-semibold text-gray-900 hover:text-black px-6 py-3.5 sm:px-4 sm:py-3 transition-colors duration-200 group rounded-full sm:rounded-none border border-gray-200/80 sm:border-0 bg-white/70 sm:bg-transparent backdrop-blur-sm sm:backdrop-blur-none"
            >
