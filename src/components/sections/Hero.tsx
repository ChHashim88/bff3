...
export default function Hero({ onOpenWaitlist }: HeroProps) {
  return (
    <section className="relative w-full min-h-[calc(100vh-64px)] sm:min-h-[calc(100vh-80px)] py-16 sm:py-20 lg:py-28 flex flex-col justify-center overflow-hidden border-b border-gray-200/70">
      {/* Background Image: heroback.jpeg (Desktop: 100% Original | Mobile: Framed) */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <Image
          ...
          fill
          priority
          className="object-cover object-[82%_center] md:object-center opacity-75 md:opacity-100 transition-opacity duration-300"
          sizes="100vw"
        />
        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center justify-center sm:justify-start gap-2.5 bg-black hover:bg-neutral-800 text-white text-sm sm:text-base font-semibold px-7 sm:px-8 py-3.5 sm:py-4 rounded-full sm:rounded-sm transition-all duration-200 shadow-lg cursor-pointer group"
            >
