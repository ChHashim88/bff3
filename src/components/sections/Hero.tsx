...
export default function Hero({ onOpenWaitlist }: HeroProps) {
  return (
    <section className="relative w-full min-h-[calc(100vh-64px)] sm:min-h-[calc(100vh-80px)] pt-10 sm:pt-20 lg:pt-28 pb-16 sm:pb-20 lg:pb-28 flex flex-col justify-start md:justify-center overflow-hidden border-b border-gray-200/70">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
        <motion.div
          ...
          className="max-w-2xl space-y-7 sm:space-y-10"
        >
          {/* Creative Pill Badge */}
          <motion.div
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold text-gray-900 tracking-tight leading-[1.25] sm:leading-[1.18] space-y-1.5 sm:space-y-2"
          >
            <div>Everyday investors.</div>
            <div>Real ownership.</div>
            <div>
          ...
          <motion.p
            ...
            className="text-base sm:text-lg lg:text-xl text-gray-800 font-normal max-w-xl leading-relaxed sm:leading-[1.75]"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-6 pt-3"
          >
            <motion.button
