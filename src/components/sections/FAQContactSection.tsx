      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-20 relative z-10 space-y-14">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-bold tracking-[0.18em] uppercase text-[#CD0007]">
              INVESTOR SUPPORT
            </span>
          </div>
          <h2 className="text-[19px] sm:text-[32px] md:text-[44px] lg:text-[50px] font-bold text-[#111111] leading-[1.06] tracking-tight">
            Every Question,{" "}
