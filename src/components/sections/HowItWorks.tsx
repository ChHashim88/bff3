  ...
  const steps = [
    {
      ...
      description: "A steady pipeline sourced through a broad, differentiated intake",
      image: "/4.jpeg",
      alt: "Access to Quality Projects",
    },
    {
      num: 2,
      icon: Search,
      title: "Disciplined Selection",
      description: "Screened using financial and commercial criteria",
      image: "/3.jpeg",
    ...
    },
    {
      num: 3,
      icon: Target,
      title: "Distribution & Audience Reach",
      description: "Built with clear pathways to market and audience engagement",
      image: "/2.jpeg",
      alt: "Distribution and Audience Reach",
    },
    {
      num: 4,
      icon: Landmark,
      title: "Financial & Platform Discipline",
      description: "Portfolio-driven capital allocation and structured execution",
      image: "/1.jpeg",
      alt: "Financial and Platform Discipline",
    },
    {
      num: 5,
      icon: TrendingUp,
      title: "A Growing Investor Base",
      description: "A community participating across multiple offerings over time",
      image: "/5.jpeg",
      alt: "A Growing Investor Base",
    },
  ];

  const summaryItems = [
    { icon: ClipboardCheck, title: "Quality Sourcing", description: "A steady pipeline sourced through a broad, differentiated intake", floatDuration: 4.2, floatDelay: 0 },
    { icon: Search, title: "Selection", description: "Screened using financial and commercial criteria", floatDuration: 4.8, floatDelay: 0.5 },
    { icon: Target, title: "Distribution & Reach", description: "Built with clear pathways to market and audience engagement", floatDuration: 4.4, floatDelay: 1.0 },
    { icon: Landmark, title: "Platform Discipline", description: "Portfolio-driven capital allocation and structured execution", floatDuration: 5.0, floatDelay: 1.5 },
    { icon: TrendingUp, title: "Investor Base", description: "A community participating across multiple offerings over time", floatDuration: 4.6, floatDelay: 2.0 },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          >
            <VideoPlayerWithLoader
              primarySrc="https://www.dropbox.com/scl/fo/fr0i9s0r31wvmmwctfvf3/ACgQM7ywKfShxxLvdVhG4sw?dl=0&e=3&preview=bff_promo_4_why_bff_will_win_260602_v1.mp4&rlkey=d1069gkyon7op9goc3htz7340&st=4n2g1pd0"
              fallbackSrc="/bff_platform.mp4"
              poster="/ggh.jpeg"
            />
          </motion.div>
