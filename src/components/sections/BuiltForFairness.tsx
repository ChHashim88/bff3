    ...
    <section className="relative w-full bg-white border-b border-gray-100 overflow-hidden py-10 sm:py-16 lg:py-22">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          className="block lg:hidden relative rounded-sm border border-gray-200 bg-white p-6 sm:p-8 overflow-hidden shadow-xs flex flex-col justify-center min-h-[250px]"
        >
        ...
        <div className="hidden lg:grid lg:grid-cols-12 items-center gap-12 lg:gap-14">
          ...
          >
            <h2 className="text-5.5xl lg:text-6.5xl font-bold text-gray-900 tracking-tight leading-[1.08]">
              Built for fairness.
              <br />
              Designed for investors.
            </h2>
            <p className="text-xl lg:text-2xl text-gray-600 font-medium leading-relaxed max-w-xl">
              We combine data, technology, and people to find the best stories — together.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="lg:col-span-5 relative h-[350px] lg:h-[420px] w-full flex items-center justify-end overflow-hidden"
          >
