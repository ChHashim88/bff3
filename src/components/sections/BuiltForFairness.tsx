...
export default function BuiltForFairness() {
  return (
    <section className="relative w-full bg-white border-b border-gray-100 overflow-hidden py-12 sm:py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          className="block lg:hidden relative rounded-sm border border-gray-200 bg-white p-6 sm:p-10 overflow-hidden shadow-xs flex flex-col justify-center min-h-[260px]"
        >
        ...
        <div className="hidden lg:grid lg:grid-cols-12 items-center gap-12 lg:gap-16">
          ...
          <motion.div
            ...
            className="lg:col-span-6 relative h-[360px] lg:h-[400px] w-full flex items-center justify-end overflow-hidden"
          >
