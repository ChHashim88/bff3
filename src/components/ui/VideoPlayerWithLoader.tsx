...
export default function VideoPlayerWithLoader({
  ...
  useEffect(() => {
    ...
    // IntersectionObserver to auto-pause offscreen videos for 60 FPS performance
  ...
  return (
    <div className={`relative rounded-2xl border border-[#EAE5DC] overflow-hidden shadow-xl bg-[#111111] group w-full h-auto sm:min-h-[320px] lg:min-h-[350px] ${aspectRatioClass}`}>
      ...
      {isLoading && (
        <div className="absolute inset-0 bg-[#111111] z-30 flex flex-col items-center justify-center gap-3 transition-opacity duration-300 pointer-events-none">
