  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[340px] xs:max-w-[370px] sm:max-w-[400px] aspect-square flex items-center justify-center my-2 p-1">
        ...
        {/* Nodes positioned dynamically around outer track */}
        {items.map((item, i) => {
        ...
        <div className="w-[185px] xs:w-[205px] sm:w-[225px] aspect-square rounded-full bg-[#FAF8F3] border border-[#EAE5DC] shadow-[0_6px_18px_rgba(205,0,7,0.12)] flex flex-col items-center justify-center p-4 text-center z-10 overflow-hidden relative">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Icon Badge */}
              <div className="w-9 h-9 rounded-full bg-[#CD0007]/10 text-[#CD0007] flex items-center justify-center my-0.5 shadow-2xs">
                <Icon size={18} strokeWidth={1.8} />
              </div>

              {/* Title */}
              <h3 className="type-h3 text-xs xs:text-sm font-bold text-[#111111] leading-tight line-clamp-2 px-1">
                {activeItem.title}
              </h3>

              {/* Description */}
              <p className="text-[11px] xs:text-xs text-gray-700 leading-snug line-clamp-3 px-1">
